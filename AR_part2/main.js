...
document.addEventListener('DOMContentLoaded', () => {
  const start = async() => {
    const mindarThree = new MindARThree({
      ...
      imageTargetSrc: '../../assets/targets/targets11.mind',
      maxTrack: 2,
    });
    ...
    const butterfly1 = await loadGLTF('../../assets/models/combination.gltf');
    butterfly1.scene.scale.set(0.1, 0.1, 0.1);
    butterfly1.scene.position.set(-0.2, -0.2, 0);

    const monster1 = await loadGLTF('../../assets/models/monster2.gltf');
