...
document.addEventListener('DOMContentLoaded', () => {
  const start = async() => {
    const mindarThree = new MindARThree({
      ...
      imageTargetSrc: '../../assets/targets/postcards.mind',
    });
    ...
    const butterfly1 = await loadGLTF('../../assets/models/postcard/butterfly.gltf');
    butterfly1.scene.scale.set(0.2, 0.2, 0.2);
    butterfly1.scene.rotation.set(0, 90, 0);
    butterfly1.scene.position.set(-0.1, -0.4, 0);

    const monster1 = await loadGLTF('../../assets/models/monster1.glb');
    monster1.scene.scale.set(0.1, 0.1, 0.1);
    monster1.scene.position.set(0, -0.4, 0);
